...
- Technische Implementierung einer Funktion oder einer Sammlung von Funktionen von Grund auf
- Empfehlungen zu Code-Änderungen durch LLM-basierte Prüfsysteme
- Prüfung von Code innerhalb von formellen "Review"-Verfahren
...
- Recherchearbeiten, sofern sie abschließend unabhängig geprüft werden
- Technische Problemlösung, beispielsweise durch LLM-basierte Konversationen
- Prädiktive Generierung von minimalen unmittelbar überprüfbaren Code-Teilen, d.h. "Tab Completion" und vergleichbare Funktionen
- Generierung in sich abgeschlossener kleiner Code-Teile, beispielsweise Hilfsfunktionen, sofern diese ihr Umfeld nicht beeinflussen können, d.h. nebeneffektfrei sind, und dem Stil umliegender Arbeiten folgen
